...
export const WelcomeEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to MeetNotes. Verify your email to start uploading recordings.</Preview>
      <Tailwind>
        <Body className="m-0 bg-slate-100 px-4 py-10 font-sans">
          <Container className="mx-auto max-w-xl rounded-2xl bg-white p-10">
            ...
            <Text className="mb-0 mt-5 text-base leading-7 text-slate-700">
              Thanks for joining MeetNotes with <strong>{email}</strong>. Confirm
              your email address to activate your account and upload your first
              meeting recording.
            </Text>
...
WelcomeEmail.PreviewProps = {
  ...
  name: "John Doe",
  redirectUrl: "https://app.meetnotes.localhost/verify?token=abc123",
};
